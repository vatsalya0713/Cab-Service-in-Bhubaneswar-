...
export const SITE_CONFIG = {
  ...
  email: "info@voyagetravelsbbsr.com",
  address: "Bramheswar, Ln 3, Palasuni, Bhubaneswar, Odisha 751025",
...
export const DESTINATIONS = [
  ...
  {
    id: "rourkela",
    slug: "bhubaneswar-to-rourkela",
    name: "Rourkela",
    distance: "330",
    duration: "7 hrs",
    startingFare: 3800,
    description: "The Steel City of Odisha, perfect for corporate and business trips",
    highlights: ["Steel Plant", "Hanuman Vatika", "Khandadhar Waterfall"],
    image: "/images/dest-rourkela.jpg",
    vehicles: ["Dzire", "Ertiga", "Innova"],
    badge: undefined,
    label: undefined,
  },
  {
    ...
    duration: "9 hrs",
    startingFare: 5000,
    description: "The City of Joy, comfortable outstation inter-state taxi service",
    highlights: ["Victoria Memorial", "Howrah Bridge", "Dakshineswar Temple"],
    image: "/images/dest-kolkata.jpg",
    vehicles: ["Ertiga", "Innova"],
    badge: undefined,
    label: undefined,
  },
] as const;
