...
export default function QuoteForm({ className }: { className?: string }) {
  ...
  return (
    <form
      ...
      className={`bg-[#f4f7f9] rounded-2xl border border-[#e2e8f0] shadow-xl p-4 md:p-5 space-y-3 ${className || ""}`}
      noValidate
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2">
          <label htmlFor="quote-service" className="block text-xs font-medium text-[#1f2937] mb-1">Service Required *</label>
          <select
            id="quote-service"
            {...register("service")}
            className="w-full px-3 py-2 rounded-lg border border-[#e2e8f0] bg-[#ffffff] text-xs focus:outline-none focus:ring-2 focus:ring-[#15456b]/30 focus:border-[#15456b] transition-all appearance-none"
          >
        ...
        {/* Vehicle */}
        <div className="sm:col-span-2">
          <label htmlFor="quote-vehicle" className="block text-xs font-medium text-[#1f2937] mb-1">Vehicle Type</label>
          <select
            id="quote-vehicle"
            {...register("vehicle")}
            className="w-full px-3 py-2 rounded-lg border border-[#e2e8f0] bg-[#ffffff] text-xs focus:outline-none focus:ring-2 focus:ring-[#15456b]/30 focus:border-[#15456b] transition-all appearance-none"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className="w-full flex items-center justify-center gap-2 py-3 rounded-lg font-bold text-sm text-[#15456b] bg-[#FFB800] hover:bg-[#F2A900] transition-all disabled:opacity-70 mt-2"
      >
