        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 lg:px-8 flex items-center justify-between gap-2 lg:gap-4">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              id="nav-call-btn"
              className="hidden lg:flex items-center justify-center gap-1.5 px-3 xl:px-4 py-2 rounded-lg text-[14.5px] font-semibold text-[#111827] bg-[#FFC107] hover:bg-[#F5B600] transition-all duration-200 shadow-sm tap-feedback whitespace-nowrap"
            >
              <Phone size={15} />
              <span>Call Now</span>
            </a>
            ...
            <a
              ...
              id="nav-whatsapp-btn"
              className="hidden lg:flex items-center gap-1.5 px-3 xl:px-4 py-2 rounded-lg text-[14.5px] font-semibold text-white bg-[#25D366] hover:bg-[#20bd5a] transition-all duration-200 touch-target tap-feedback whitespace-nowrap"
            >
