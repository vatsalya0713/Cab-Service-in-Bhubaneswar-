          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <a href={SITE_CONFIG.whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 card-base p-4 hover:-translate-y-0.5 transition-transform duration-200">
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 text-white" style={{ background: "linear-gradient(135deg, #25D366, #128C7E)" }}>
                  <MessageCircle size={22} />
                </div>
                <div>
                  <div className="font-bold text-[#1C1C1E]">WhatsApp (Fastest)</div>
                  <div className="text-sm text-[#136F63]">{SITE_CONFIG.phone} — Instant Response</div>
                </div>
              </a>
              ...
              <a href={`tel:${SITE_CONFIG.phone}`} className="flex items-center gap-4 card-base p-4 hover:-translate-y-0.5 transition-transform duration-200">
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 text-white" style={{ background: "linear-gradient(135deg, #136F63, #1E8F7F)" }}>
                  <Phone size={22} />
                </div>
                <div>
                  <div className="font-bold text-[#1C1C1E]">Call Us</div>
                  <div className="text-sm text-[#136F63]">{SITE_CONFIG.phone} — 24/7</div>
                </div>
              </a>
              ...
              <a href={`mailto:${SITE_CONFIG.email}`} className="flex items-center gap-4 card-base p-4 hover:-translate-y-0.5 transition-transform duration-200">
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 text-white" style={{ background: "linear-gradient(135deg, #F2A93B, #D98F1F)" }}>
                  <Mail size={22} />
                </div>
                <div>
              ...
              <div className="flex items-center gap-4 card-base p-4">
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 text-white bg-[#1C1C1E]">
                  <Clock size={22} />
                </div>
                <div>
            ...
            <div className="rounded-2xl overflow-hidden h-64 bg-[#E7E2D8] flex items-center justify-center border border-[#E7E2D8]">
              <iframe
