      ...
      <section className="pt-24 pb-16" style={{ background: "linear-gradient(135deg, #0F4C4C 0%, #136F63 100%)" }}>
        <div className="section-container">
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-[#F2A93B]/20 text-[#F7C46C] flex items-center gap-1">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              <div className="card-base p-5">
                ...
                <a href={SITE_CONFIG.whatsappLink} target="_blank" rel="noopener noreferrer" className="block w-full text-center py-3 rounded-xl font-bold text-white text-sm" style={{ background: "linear-gradient(135deg, #136F63, #1E8F7F)" }}>
                  Book on WhatsApp
                </a>
              </div>
              <Link href="/blog" className="flex items-center gap-2 text-sm text-[#136F63] font-medium hover:underline">
