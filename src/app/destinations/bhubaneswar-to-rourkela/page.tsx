...
export const metadata: Metadata = {
  title: "Bhubaneswar to Rourkela Cab | Taxi Fare & Booking",
  description: "Book a cab from Bhubaneswar to Rourkela starting ₹3800. Distance 330 km, ~7 hrs. One-way & round trip. 24/7 verified drivers. WhatsApp booking.",
  alternates: { canonical: `${SITE_CONFIG.url}/destinations/bhubaneswar-to-rourkela` },
  openGraph: { title: "Cab from Bhubaneswar to Rourkela", description: "Bhubaneswar to Rourkela cab — 330 km, ~7 hrs.", url: `${SITE_CONFIG.url}/destinations/bhubaneswar-to-rourkela`, images: [{ url: "/images/dest-rourkela.jpg", width: 1200, height: 630, alt: "Rourkela Steel City" }] },
    ...
    <div>
      <section className="pt-24 pb-0 relative" style={{ background: "linear-gradient(135deg, #0d2a40 0%, #15456b 100%)" }}>
        <div className="section-container pb-16">
          <Breadcrumbs items={[{ label: "Destinations", href: "/destinations" }, { label: "Bhubaneswar to Rourkela" }]} className="text-white/60 mb-6" />
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Cab from Bhubaneswar to Rourkela</h1>
          <p className="text-white/70 max-w-2xl text-lg">330 km · ~7 hours · Starting ₹3800. Travel safely to the Steel City of Odisha with our verified drivers.</p>
          <div className="flex gap-6 mt-6 text-white/80 text-sm">
            <span className="flex items-center gap-2"><MapPin size={15} className="text-[#FFC107]" /> 330 km from Bhubaneswar</span>
            <span className="flex items-center gap-2"><Clock size={15} className="text-[#FFC107]" /> ~7 hours drive</span>
            <span className="flex items-center gap-2"><IndianRupee size={15} className="text-[#FFC107]" /> From ₹3800 one-way</span>
          </div>
        </div>
      </section>
      ...
      <section className="section-container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <h3 className="text-xl font-bold text-[#1f2937] mb-3">Highlights at Rourkela</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {["Steel Plant", "Hanuman Vatika", "Khandadhar Waterfall", "Vedvyas Temple", "Indira Gandhi Park", "NIT Rourkela"].map((h) => (
