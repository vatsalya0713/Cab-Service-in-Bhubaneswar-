      ...
      <section className="pt-24 pb-0 relative" style={{ background: "linear-gradient(135deg, #0d2a40 0%, #15456b 100%)" }}>
        <div className="section-container pb-16">
          ...
          <div className="flex gap-6 mt-6 text-white/80 text-sm">
            <span className="flex items-center gap-2"><MapPin size={15} className="text-[#FFC107]" /> 60 km from Bhubaneswar</span>
            <span className="flex items-center gap-2"><Clock size={15} className="text-[#FFC107]" /> ~1.5 hours drive</span>
            <span className="flex items-center gap-2"><IndianRupee size={15} className="text-[#FFC107]" /> From ₹700 one-way</span>
          </div>
        </div>
      </section>
      ...
      <section className="section-container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <h3 className="text-xl font-bold text-[#1f2937] mb-3">Highlights at Puri</h3>
