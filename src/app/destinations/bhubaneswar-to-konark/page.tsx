      ...
      <section className="pt-24 pb-16" style={{ background: "linear-gradient(135deg, #A5811C 0%, #C9A227 100%)" }}>
        <div className="section-container">
          ...
          <div className="flex flex-wrap gap-6 mt-6 text-white/80 text-sm">
            <span className="flex items-center gap-2"><MapPin size={15} className="text-[#C9A227]" /> 65 km from Bhubaneswar</span>
            <span className="flex items-center gap-2"><Clock size={15} className="text-[#C9A227]" /> ~1.5 hours drive</span>
            <span className="flex items-center gap-2"><IndianRupee size={15} className="text-[#C9A227]" /> From ₹800 one-way</span>
          </div>
        </div>
      </section>
      ...
      <section className="section-container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#F5F1E8] mb-4">Konark — The Sun Temple of Odisha</h2>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#F5F1E8] mb-4">Konark Cab Fare from Bhubaneswar</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#F5F1E8] mb-3">What to See in Konark</h3>
