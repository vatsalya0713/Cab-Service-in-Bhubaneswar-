      ...
      <section className="pt-24 pb-16" style={{ background: "linear-gradient(135deg, #0d2a40 0%, #15456b 100%)" }}>
        <div className="section-container">
          ...
          <div className="flex flex-wrap gap-6 mt-6 text-white/80 text-sm">
            <span className="flex items-center gap-2"><MapPin size={15} className="text-[#FFC107]" /> 100 km from Bhubaneswar</span>
            <span className="flex items-center gap-2"><Clock size={15} className="text-[#FFC107]" /> ~2.5 hours drive</span>
            <span className="flex items-center gap-2"><IndianRupee size={15} className="text-[#FFC107]" /> From ₹1,100 one-way</span>
          </div>
        </div>
      </section>
      ...
      <section className="section-container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1f2937] mb-4">Chilika Lake — Asia&apos;s Largest Brackish Lagoon</h2>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#1f2937] mb-4">Chilika Cab Fare from Bhubaneswar</h3>
