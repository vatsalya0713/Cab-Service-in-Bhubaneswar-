      ...
      <section className="pt-24 pb-16" style={{ background: "linear-gradient(135deg, #0F4C4C 0%, #136F63 100%)" }}>
        <div className="section-container">
          ...
          <div className="flex flex-wrap gap-6 mt-6 text-white/80 text-sm">
            <span className="flex items-center gap-2"><MapPin size={15} className="text-[#F2A93B]" /> 100 km from Bhubaneswar</span>
            <span className="flex items-center gap-2"><Clock size={15} className="text-[#F2A93B]" /> ~2.5 hours drive</span>
            <span className="flex items-center gap-2"><IndianRupee size={15} className="text-[#F2A93B]" /> From ₹1,100 one-way</span>
          </div>
        </div>
      </section>
      ...
      <section className="section-container py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#1C1C1E] mb-4">Chilika Lake — Asia&apos;s Largest Brackish Lagoon</h2>
            ...
            <div>
              <h3 className="text-xl font-bold text-[#1C1C1E] mb-4">Chilika Cab Fare from Bhubaneswar</h3>
